			...
			<view class="uni-btn-v">
				...
				<view v-if="valueChangeData.serviceId">
					<view class="list-name">
						特征值最新的值:{{ valueChangeData.value[0] || '还没有最新值' }}
					</view>
				</view>
...
export default {
	...
	methods: {
		...
		readBLECharacteristicValue() {
			let deviceId = this.equipment[0].deviceId;
			let serviceId = this.servicesData[0].uuid.toLowerCase();
			let characteristicId = this.characteristicsData[0].uuid.toLowerCase();
			console.log(deviceId);
			console.log(serviceId);
